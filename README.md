...
Güncel geliştirme sürümü `1.1.0-alpha.23`tür. Sürüm ve canlı ortam ayrıntıları için [STATUS.md](STATUS.md), mimari için [docs/YENIDEN-YAPILANDIRMA-V1.1.tr.md](docs/YENIDEN-YAPILANDIRMA-V1.1.tr.md) belgesine bakın.
...
- Test istemcisi: https://rotaniz.com/downloads/RotaLink-v1.1.0-alpha.23-UNSIGNED-DEVELOPMENT.exe
