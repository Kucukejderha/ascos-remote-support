...
$checks = @(
    ...
    @{ Id="native-shell-automation"; Passed=($cmake.Contains('NativeShellAutomation.cpp') -and $cmake.Contains('uiautomationcore') -and $cmake.Contains('oleacc') -and $shellAutomation.Contains('AccessibleObjectFromPoint') -and $shellAutomation.Contains('accSelect') -and $shellAutomation.Contains('accDoDefaultAction') -and $shellAutomation.Contains('WM_CONTEXTMENU') -and $shellAutomation.Contains('UIA_InvokePatternId') -and $inputEngine.Contains('Native shell automation result')) },
