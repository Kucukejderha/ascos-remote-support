...
public static class SelfInstaller
{
    ...
    public static int Install()
    {
        try
        {
            ...
            if (testRoot is null)
            {
                MessageBox(IntPtr.Zero, "ASCOS Uzaktan Destek başarıyla kuruldu. Masaüstü kısayolu oluşturuldu.", "ASCOS Uzaktan Destek", 0x40u | 0x1000u);
        ...
        {
            MessageBox(IntPtr.Zero, $"Kurulum tamamlanamadı.\n\n{exception.Message}", "ASCOS Uzaktan Destek — Kurulum Hatası", 0x10u | 0x1000u);
            return 1;
        }
    }
